//problem statement
/*
    At the annual meeting of MOOC fans,
    participants register on the first day of the event in order to receive their name tags,
    brochures and banquet vouchers.
    Unfortunately this often results in long lines.
    In an attempt to speed things up,
    there are now two people working the registration desk:
    ...
    you may assume that student names are less than 50 characters long and contain no spaces.
...
main(void)
{
    ...
    //determine which queue should the user use
    printf("%d", (((--i)%2)? 2:1));
